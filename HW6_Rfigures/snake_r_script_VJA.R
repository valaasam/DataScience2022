...
setwd("~/Desktop/JulieMA/Part.4.DataVisualization/DataVisualization")
...
#HOMEWORK: Remake 2.4 with color pallette you like
...
zpoints(as.numeric(map_matrix[1,4]), as.numeric(map_matrix[1,3]), pch=24, bg="#B2182B", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[2,4]), as.numeric(map_matrix[2,3]), pch=24, bg="#B2182B", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[3,4]), as.numeric(map_matrix[3,3]), pch=24, bg="#B2182B", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[4,4]), as.numeric(map_matrix[4,3]), pch=24, bg="#B2182B", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[5,4]), as.numeric(map_matrix[5,3]), pch=24, bg="#D6604D", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[6,4]), as.numeric(map_matrix[6,3]), pch=24, bg="#D6604D", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[7,4]), as.numeric(map_matrix[7,3]), pch=24, bg="#D6604D", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[8,4]), as.numeric(map_matrix[8,3]), pch=24, bg="#D6604D", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[9,4]), as.numeric(map_matrix[9,3]), pch=24, bg="#D6604D", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[10,4]), as.numeric(map_matrix[10,3]), pch=24, bg="#D6604D", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[11,4]), as.numeric(map_matrix[11,3]), pch=24, bg="#D6604D", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[12,4]), as.numeric(map_matrix[12,3]), pch=24, bg="#F4A582", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[13,4]), as.numeric(map_matrix[13,3]), pch=24, bg="#F4A582", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[14,4]), as.numeric(map_matrix[14,3]), pch=24, bg="#F4A582", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[15,4]), as.numeric(map_matrix[15,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[16,4]), as.numeric(map_matrix[16,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[17,4]), as.numeric(map_matrix[17,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[18,4]), as.numeric(map_matrix[18,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[19,4]), as.numeric(map_matrix[19,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[20,4]), as.numeric(map_matrix[20,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[21,4]), as.numeric(map_matrix[21,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[22,4]), as.numeric(map_matrix[22,3]), pch=22, bg="#FDDBC7", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[23,4]), as.numeric(map_matrix[23,3]), pch=21, bg="D1E5F0", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[24,4]), as.numeric(map_matrix[24,3]), pch=21, bg="D1E5F0", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[25,4]), as.numeric(map_matrix[25,3]), pch=21, bg="D1E5F0", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[26,4]), as.numeric(map_matrix[26,3]), pch=21, bg="D1E5F0", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[27,4]), as.numeric(map_matrix[27,3]), pch=3, bg="#92C5DE", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[28,4]), as.numeric(map_matrix[28,3]), pch=25, bg="#4393C3", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[29,4]), as.numeric(map_matrix[29,3]), pch=25, bg="#4393C3", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[30,4]), as.numeric(map_matrix[30,3]), pch=25, bg="#2166AC", cex=2.5, lwd=1.5)
points(as.numeric(map_matrix[31,4]), as.numeric(map_matrix[31,3]), pch=25, bg="#2166AC", cex=2.5, lwd=1.5)
legend("topleft", legend=c("T. elegans (TTXs)", "T. couchii (TTXr.m)", "T. atratus (TTXs)", "T. atratus (TTXr.m)", "T. atratus (TTXr.x)", "T. hammondii (TTXs)",
                           "T. sirtalis (TTXr.m)", "T. sirtalis (TTXr.x)"), pch=c(21,22,24,24,24,3,25,25), pt.bg=c("#B2182B", "#D6604D", "#F4A582", "#FDDBC7", "#D1E5F0", "#92C5DE", "#4393C3", "#2166AC"),
       pt.cex=2, pt.lwd=1.5, box.lwd=1)

plot(snake_data[,6], snake_data[,7], type="n", xlab="Principal component 2", ylab="Principal component 1", cex.lab=1.25, las=1); box(lwd=2)
rect(par("usr")[1], par("usr")[3], par("usr")[2], par("usr")[4], col="grey92")
points(snake_data[snake_data[,5]=="atratus_EPN",6], snake_data[snake_data[,5]=="atratus_EPN",7], pch=24, bg="#F4A582", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="atratus_P",6], snake_data[snake_data[,5]=="atratus_P",7], pch=24, bg="#D1E5F0", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="atratus_WT",6], snake_data[snake_data[,5]=="atratus_WT",7], pch=24, bg="#FDDBC7", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="couchii_T",6], snake_data[snake_data[,5]=="couchii_T",7], pch=22, bg="#D6604D", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="elegans_WT",6], snake_data[snake_data[,5]=="elegans_WT",7], pch=21, bg="#B2182B", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="hammondii_WT",6], snake_data[snake_data[,5]=="hammondii_WT",7], pch=3, bg="#92C5DE", cex=1.5, lwd=1.25)
...
points(snake_data[snake_data[,5]=="sirtalis_V",6], snake_data[snake_data[,5]=="sirtalis_V",7], pch=25, bg="#4393C3", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="sirtalis_V/VA",6], snake_data[snake_data[,5]=="sirtalis_V/VA",7], pch=25, bg="#4393C3", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="sirtalis_VA",6], snake_data[snake_data[,5]=="sirtalis_VA",7], pch=25, bg="#4393C3", cex=1.5, lwd=1.25)
points(snake_data[snake_data[,5]=="sirtalis_WT",6], snake_data[snake_data[,5]=="sirtalis_WT",7], pch=25, bg="#2166AC", cex=1.5, lwd=1.25)
